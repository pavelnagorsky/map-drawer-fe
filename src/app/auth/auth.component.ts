...
import { SignupRequestData, LoginRequestData } from './auth.service';
import { RegExps } from '../shared/utils/reg-exps';
  ...
  private initForm() {
    ...
    this.authForm = this.fb.group({
      ...
      'password': ['', [
        ...
        Validators.pattern(RegExps.EnNumbers)
      ]]
    });
    ...
    this.authForm.addControl(
      'username', new FormControl(
        '', [
          ...
          Validators.pattern(RegExps.RusEnNumbers)
        ]
      )
    )
  }
